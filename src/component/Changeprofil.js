...
import "../component/Changeprofil.css";
    ...
    <section className='user1 col-lg-10 col-md-10 col-sm-7 col-9 '>
      ...
      <main className='pro bg-secondary-subtle'>
            ...
            <div className='profile3'>
                ...
                <div className='row '>
                <div className='columns mt-3 col-lg-4 '>
                    <label className='col-lg-12 '>Old Password</label>
                    <input className='col-lg-8' type="password" name='pass' id='pass'/>
                </div>
                <div className='columns mt-3 col-lg-4'>
                    <label className='col-lg-12 '>New Password</label>
                    <input className='col-lg-8 ' type="password" name='pass' id='pass'/>
                </div>
                <div className='columns mt-3 col-lg-4'>
                    <label className='col-lg-12 '>Conform New Password</label>
                    <input className='col-lg-8 ' type="password" name='pass' id='pass'/>
                </div>
                </div>
